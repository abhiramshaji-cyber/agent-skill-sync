...
directly and adapts commands into `claude-command-*` Codex skills. Helper files
referenced by a command are copied into the generated skill as well.
...
Claude commands become Codex skills named `claude-command-<command>`. Invoke
them through Codex's skill picker or by asking Codex to use that skill.
